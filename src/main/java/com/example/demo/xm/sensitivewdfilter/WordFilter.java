package com.example.demo.xm.sensitivewdfilter;


import com.example.demo.xm.sensitivewdfilter.util.BCConvert;
...
public class WordFilter {
	...
	private static char SIGN = '1'; // 敏感词过滤替换
	...
	public static final String doFilter(final String src) {
		if (set != null && nodes != null) {
			...
			return new String(s.replaceAll("\\d+",""));
