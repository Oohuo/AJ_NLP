...
import com.example.demo.xm.similarity.text.EditDistanceSimilarity;
...
/**
 * @ClassName EditDistanceSimilarityController
 * @Description TODO
 * @Author H Z
 * @Date 2020-03-08 1:29
 * @Version 1.0
 **/
@RestController
@RequestMapping(path = "/api")
public class EditDistanceSimilarityController {
    @RequestMapping(value = "/getSentenceEditDistanceSimilarity")
    public SentenceSimilarityEntity getSimilarity(@RequestParam(value="s1",required = false,defaultValue = "1") String s1, @RequestParam(value="s2",required = false,defaultValue = "1") String s2){
        ...
        double sim = textSimilarity.getSimilarity(s1, s2);
